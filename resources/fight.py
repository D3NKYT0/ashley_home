...
class Entity(object):
    ...
    def get_skill_menu(self, entity, user, skills, wave_now, passive_skill):
        ...
        if passive_skill:
            ...
            text_passive = ""
            if not self.is_passive and self.passive in ["necromancer", "priest", "warlock", "assassin"]:
    ...
    async def turn(self, ctx, user, entity, wave_now=0):
        ...
        if stun is False and ice is False:
            if self.is_player:
                ...
                # verificação da skill base do priest / warlock
                self_passive = False
                if effects is not None:
        ...
        if not self.is_passive and self.passive in ["priest", "warlock", "assassin"]:
