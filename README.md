...
- [Booket](#booket-commands)
  - [bok](#bok)
- [BossSystem](#bosssystem-commands)
  - [boss](#boss)
...
- [BoxClass](#boxclass-commands)
  ...
  - [box buy](#box-buy)
- [CaptchaClass](#captchaclass-commands)
  - [captcha](#captcha)
...
- [CreateClass](#createclass-commands)
  - [create](#create)
...
- [EnchanterClass](#enchanterclass-commands)
  ...
  - [enchanter_armor](#enchanter_armor)
  - [enchanter_weapon](#enchanter_weapon)
...
- [LogoutCog](#logoutcog-commands)
  - [logout](#logout)
- [LotteryClass](#lotteryclass-commands)
  - [lottery](#lottery)
...
- [PushClass](#pushclass-commands)
  - [push](#push)
- [QuestClass](#questclass-commands)
  - [quest](#quest)
  - [quest test](#quest-test)
- [Raid](#raid-commands)
  - [wave](#wave)
...
- [RegisterClass](#registerclass-commands)
  ...
  - [research](#research)
  - [research satisfaction](#research-satisfaction)
...
- [TopClass](#topclass-commands)
  - [top](#top)
  - [top black](#top-black)
  - [top blessed](#top-blessed)
  - [top command](#top-command)
  - [top fragment](#top-fragment)
  - [top level](#top-level)
  - [top money](#top-money)
  - [top point](#top-point)
...
#### adfly
>**Descrição:** Comando de mineração de fragmento de Blessed Ethernyas

>**Modo de Uso:** `ash adfly [item]`

#### adlink
>**Descrição:** Comando de resgate de mineração de fragmento de Blessed Ethernyas

>**Modo de Uso:** `ash adlink [code]`
...
#### captcha
>**Descrição:** comando pra verificar se você é humano
Use ash captcha

>**Modo de Uso:** `ash captcha `
...
#### enchant
>**Descrição:** Comando usado pra ver os encantamentos das suas habilidades no rpg da Ashley
Use ash enchant
...
>**Modo de Uso:** `ash enchant add [skill] [enchant]`

#### enchanter_armor
>**Descrição:** Comando usado pra encantar suas habilidades no rpg da Ashley
Use ash enchant add numero_da_skill

>**Modo de Uso:** `ash enchanter_armor [armor] [enchant]`

#### enchanter_weapon
>**Descrição:** Comando usado pra encantar suas habilidades no rpg da Ashley
Use ash enchant add numero_da_skill

>**Modo de Uso:** `ash enchanter_weapon [enchant]`
...
>**Modo de Uso:** `ash guess [resposta]`
...
#### lottery
>**Descrição:** loteria da ashley

>**Modo de Uso:** `ash lottery [amount]`
...
>**Modo de Uso:** `ash merc add [value] [amount] [item]`

#### merc buy
>**Descrição:** Comando para comprar itens das lojas do mercado.

>**Modo de Uso:** `ash merc buy [id_shop] [amount]`

#### merc list
>**Descrição:** Comando para ver as lojas no mercado

>**Modo de Uso:** `ash merc list [page=0]`

#### merc rem
>**Descrição:** Comando para remover uma loja do mercado

>**Modo de Uso:** `ash merc rem [id_shop]`

#### merchant
>**Descrição:** Mercado da ashley, onde todas as lojas sao dos proprios jogadores

>**Modo de Uso:** `ash merchant [page=0]`
...
>**Modo de Uso:** `ash chest `

#### discover
>**Descrição:** Abra um presente para liberar seu giftcard.

>**Modo de Uso:** `ash discover [amount=1] [item]`

#### event
>**Descrição:** Abra um presente para liberar seu giftcard.

>**Modo de Uso:** `ash event `
...
>**Modo de Uso:** `ash push [member]`

## QuestClass

#### quest
>**Descrição:** Comando usado pra retornar a lista de subcomandos de quest
Use ash quest

>**Modo de Uso:** `ash quest `

#### quest test
>**Descrição:** ...

>**Modo de Uso:** `ash quest test `
...
#### research
>**Descrição:** Sistema de Pesquisa da Ashley

>**Modo de Uso:** `ash research `

#### research satisfaction
>**Descrição:** Sistema de Pesquisa da Ashley

>**Modo de Uso:** `ash research satisfaction `
...
#### guild_verify
>**Descrição:** Comando para verificar a data de registro na ASHLEY

>**Modo de Uso:** `ash guild_verify [guild]`
...
>**Modo de Uso:** `ash user_verify [member]`
...
#### ship
>**Descrição:** Comando de Ship entre duas pessoas
Use ash ship

>**Modo de Uso:** `ash ship [member_1] [member_2]`
...
>**Modo de Uso:** `ash ticket [stone] [upgrade]`
...
#### softban
>**Descrição:** Comando para DEVs, adicionar softban em um usuario

>**Modo de Uso:** `ash softban [member]`

#### true_money
>**Descrição:** Comando usado apelas por DEVS para criar itens de crafts para doadores

>**Modo de Uso:** `ash true_money [member] [amount] [money=blessed]`

## VipSystem

#### vip
>**Descrição:** Comando usado pra retornar uma lista de todos os subcomandos de vip
Use ash vip

>**Modo de Uso:** `ash vip `

#### vip guild
>**Descrição:** Comando usado pra comprar vip guild da ashley (usavel somente no server da Ashley)
Use ash vip guild

>**Modo de Uso:** `ash vip guild [guild]`

#### vip member
>**Descrição:** Comando usado pra comprar vip da Ashley (usavel somente no server da Ashley)
Use ash vip

>**Modo de Uso:** `ash vip member `
