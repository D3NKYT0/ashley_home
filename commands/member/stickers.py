    ...
    async def sticker(self, ctx):
        ...
        if ctx.invoked_subcommand is None:
            ...
            embed.add_field(name="Stickers Commands:",
                            value=f"{self.st[121]} `yugioh` seu album na tematica do anime Yu-Gi-Oh!.\n"
                                  f"{self.st[121]} `kozmo` seu album na tematica do anime Yu-Gi-Oh!.\n"
                                  f"{self.st[121]} `especial` seu album na tematica do anime Yu-Gi-Oh!.\n"
                                  f"{self.st[121]} `cdz` seu album na tematica do anime CDZ.\n"
                                  f"{self.st[121]} `bleach` seu album na tematica do anime BLEACH.\n")
