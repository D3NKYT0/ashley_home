...
class WhatsappClass(commands.Cog):
...
mobrau zap mande uma imagem
mobrau para ser analisada!''', (145, 22), 7], ['''puta que pariu...''', (191, 200), 7],
                 ['''você é tão lixo que não pode nem ser
chamado de mobrau''', (147, 216), 7], ['''pare com as drogas''', (177, 237), 7]], 31, 1]
...
async def setup(bot):
    await bot.add_cog(WhatsappClass(bot))
